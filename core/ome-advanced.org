...
* Evil-fcitx
#+BEGIN_QUOTE
Vim-like modeling editing is awesome, it uses states/mode to provide a large enough keystroke space(and save your pinky at the same time). However, the aproch is really unfriendly to non-English users who uses an IME, they have to toggle IME again and again when jumping from state to state.
...
See [[https://github.com/fangzhouuu/evil-fcitx.el][Evil-fcitx]] for more details.
#+BEGIN_SRC emacs-lisp
;;(add-to-list 'el-get-sources
;;                   `(:name evil-fcitx :type github :url "https://github.com/fangzhouuu/evil-fcitx.el.git"))

;;(defun ome-evil-fcitx-setup()
;;  (add-to-list 'el-get-sources
;;                   `(:name evil-fcitx :type github :url
;;                           "https://github.com/fangzhouuu/evil-fcitx.el.git")))

(ome-install 'evil-fcitx)
#+END_SRC
* Evil-leader
  :PROPERTIES:
